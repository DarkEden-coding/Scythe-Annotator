...
TORCH_API at::Tensor & randint_like_generator_with_low_dtype_out_symint(const at::Tensor & self, c10::SymInt low, c10::SymInt high, ::std::optional<at::Generator> generator, ::std::optional<at::MemoryFormat> memory_format, at::Tensor & out);
} // namespace native
} // namespace at
